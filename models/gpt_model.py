...
class SelfAttn(nn.Module):
    ...
    def forward(self, token):
        ...
        wei = wei.masked_fill(self.tril[:time, :time] == 0, float('-inf')) # (B, T, T)
...
class MultiHeadSelfAttn(nn.Module):
    def __init__(self, head_num, head_size):
        ...
        self.heads = nn.ModuleList([SelfAttn(input_dim, head_size) for _ in range(head_num)])
...
class Block(nn.Module):
    def __init__(self, head_num, input_dim):
        ...
        self.sa = MultiHeadSelfAttn(head_num=head_num, head_size=head_size)
